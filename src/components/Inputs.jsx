...
import { UilSearch, UilMapMarkerQuestion } from '@iconscout/react-unicons'
  ...
  return (
    <div className='flex flex-row justify-center my-6'> 
        <div className='flex flex-row w-3/4 items-center justify-center space-x-4'>
            ...
            <UilMapMarkerQuestion size={25} className="text-white cursor-pointer transition ease-out hover:scale-125"
